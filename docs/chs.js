...
var cnItems = {
    ...
    'Available dots': '可用点数',
    '! Hard reset': '! 硬复位',
    'All letters increment +': '所有字母加+',
    'Available upgrades': '可用升级',
    'Buy all upgrades': '购买所有升级',
    'Buy for': '购买需要',
    'Buy your first upgrade': '购买你的第一个升级',
    'Get one letter upercased': '得到一个大写字母',
    'Get started': '开始',
    'Max all letters': '最大所有字母',
    'Max one letter': '最大一个字母',
    'Play for 666 hours': '玩666小时',
    'Unlock the complete alphabet': '解锁完整的字母',
